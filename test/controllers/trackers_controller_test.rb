...
class TrackersControllerTest < ActionController::TestCase
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post :create, tracker: { data: @tracker.data, event: @tracker.event, page: @tracker.page, uid: @tracker.uid }
    end
  ...
  test "should update tracker" do
    patch :update, id: @tracker, tracker: { data: @tracker.data, event: @tracker.event, page: @tracker.page, uid: @tracker.uid }
    assert_redirected_to tracker_path(assigns(:tracker))
  end
